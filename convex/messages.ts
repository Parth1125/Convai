...
export const list = query({
  ...
  handler: async (ctx, args) => {
    ...
    // below code is for debugging add show comments variable and make it true to debug this
    //   if (SHOW_COMMENTS) {
...
//store is same as send just with an extra argument role to know the role
